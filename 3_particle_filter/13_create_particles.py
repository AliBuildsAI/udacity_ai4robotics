...
#enter code here
for i in range(N):
    particle_x = random.random()*world_size
    particle_y = random.random()*world_size
    particle_orientation = random.random()*2*pi
    particle = (particle_x, particle_y, particle_orientation)
    p.append(particle)
print len(p)
