...
def slam(data, N, num_landmarks, motion_noise, measurement_noise):
    ...
    for i in range(2*N+2*num_landmarks):
        Omega = Omega.expand(Omega.dimx+1, Omega.dimy+1, list(range(Omega.dimx)), list(range(Omega.dimy)))
        Xi = Xi.expand(Xi.dimx+1, Xi.dimy, list(range(Xi.dimx)), list(range(Xi.dimy)))
    Omega.value[0][0]=1
    Omega.value[1][1]=1
    ...
    for i in range(len(data)):
        ...
        Omega.value[2*i][2*i+2]-=(1/motion_noise)
        Omega.value[2*i+1][2*i+3]-=(1/motion_noise)
        
        Omega.value[2*i+2][2*i+2]+=(1/motion_noise)
        Omega.value[2*i+3][2*i+3]+=(1/motion_noise)
        Omega.value[2*i+2][2*i]-=(1/motion_noise)
        Omega.value[2*i+3][2*i+1]-=(1/motion_noise)
        
        Xi.value[2*i][0]-=(data[i][1][0]/motion_noise)
        Xi.value[2*i+1][0]-=(data[i][1][1]/motion_noise)
        Xi.value[2*i+2][0]+=(data[i][1][0]/motion_noise)
        Xi.value[2*i+3][0]+=(data[i][1][1]/motion_noise)
        
        for j in range(len(data[i][0])):
            Omega.value[2*i][2*i]+=(1/measurement_noise)
            Omega.value[2*i+1][2*i+1]+=(1/measurement_noise)
            
            Omega.value[2*N+2*data[i][0][j][0]][2*N+2*data[i][0][j][0]]+=(1/measurement_noise)  # jth landmark x index diagonal
            Omega.value[2*N+2*data[i][0][j][0]+ 1][2*N+2*data[i][0][j][0]+ 1]+=(1/measurement_noise)  # jth landmark y index diagonal
            
            Omega.value[2*i][2*N+2*data[i][0][j][0]]-=(1/measurement_noise)
            Omega.value[2*i+1][2*N+2*data[i][0][j][0]+1]-=(1/measurement_noise)
            Omega.value[2*N+2*data[i][0][j][0]][2*i]-=(1/measurement_noise)
            Omega.value[2*N+2*data[i][0][j][0]+1][2*i+1]-=(1/measurement_noise)
            Xi.value[2*i][0]-=(data[i][0][j][1]/measurement_noise)
            Xi.value[2*i+1][0]-=(data[i][0][j][2]/measurement_noise)
            Xi.value[2*N+2*data[i][0][j][0]][0]+=(data[i][0][j][1]/measurement_noise)
            Xi.value[2*N+2*data[i][0][j][0]+1][0]+=(data[i][0][j][2]/measurement_noise)
